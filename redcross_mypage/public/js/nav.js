...
header +=                    '<li><a href="로그인,회원가입,마이페이지_02회원가입_Step1본인인증_공동 인증서.html" target="_self" class="user_anchor">회원가입</a></li>';
...
header +=                        '<a href="06통합검색.html" class="btn_search_gnb" target="_self" title="홈페이지 내 검색 이동"></a>';
header +=                    '</div>';
header +=                '</div>';
header +=            '</div>';
header +=        '</div>';
...
footer +=  								'<li class="list_link_item"><a href="01소개_01디지털서비스 개방 소개.html" target="_self" class="list_link_item_anchor">디지털서비스 개방이란?</a></li>'
...
footer +=  								'</ul>'
footer +=  								'<p class="copyright">© Ministry of the Interior and Safety. All rights reserved.</p>'
footer +=  						'</div>'
footer +=  						'<div class="area_mark">'
footer +=  			    			'<a href="http://www.webwatch.or.kr/Situation/WA_Situation.html?MenuCD=110 target="_blank" title="국가 공인 인증기관 : 웹와치 새창열림"><img src="../../public/img/logo/WA.png" border="0" alt="과학기술정보통신부 WEB ACCESSIBILITY 마크(웹 접근성 품질인증 마크)"/></a>';
footer +=  						'</div>'
footer +=  				'</div>'
footer +=  		'</div>'
...
$(document).ready(function () {
  ...
  $(".skip .skip_anchor").on("click", function () {
    ...
    $(this).parent(".skip").stop().animate({top: "-200px"});
  });
...
$(".header .wrap_lnb_search .btn_lnb_search").focusout(function (){
  ...
  if (w1024.matches) {
    ...
    $(".header.gnb_mob .lnb_list .depth01_item_anchor").attr("href", "javascript:;");
